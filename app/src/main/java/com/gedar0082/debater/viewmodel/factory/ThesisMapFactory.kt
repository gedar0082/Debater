...
class ThesisMapFactory (private val thesisRepository: ThesisRepository,
                        ...
                        private val argumentRepository: ArgumentRepository): ViewModelProvider.Factory {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ThesisMapViewModel::class.java)){
            return ThesisMapViewModel(thesisRepository, debateRepository, argumentRepository) as T
        }
