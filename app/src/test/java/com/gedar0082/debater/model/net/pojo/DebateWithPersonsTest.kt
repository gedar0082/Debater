...
class DebateWithPersonsTest {
    ...
    fun findCreatorThatExists() {
        val regulationsJson = RegulationsJson(0, 1)
        ...
        personRightsJsonList.add(PersonRightsJson(PersonJson(0, "name0", "email0","psw0"), RightJson(0, 1, 1, 0)))
        personRightsJsonList.add(PersonRightsJson(PersonJson(1, "name1", "email1","psw1"), RightJson(0, 1, 1, 0)))
        personRightsJsonList.add(PersonRightsJson(PersonJson(2, "name2", "email2","psw2"), RightJson(0, 1, 1, 1)))
        personRightsJsonList.add(PersonRightsJson(PersonJson(3, "name3", "email3","psw3"), RightJson(0, 1, 1, 0)))
